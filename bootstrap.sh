...
apt-get update
apt-get install -y mate-desktop-environment lightdm build-essential mate-terminal apt-transport-https software-properties-common
...
apt-get install -y wget apt-cacher-ng libsdl1.2debian python-software-properties debconf-utils git-core zlib1g-dev postgresql libpq-dev zip sqlite3 libsqlite3-dev pgadmin3
...
apt-get install --yes --force-yes -f docker-engine atom
